...
public class CommunicationGroupTestCase {
    ...
    public void test1Save() {
        try {
            ...
            communicationgroup.setCommGroupDescription("ZkH2cJTLgVlgeXzBPuMLJDDjeRX5XbbMsceMpXwdgaX2iNmE7K");
    ...
    public void test2Update() {
        try {
            ...
            communicationgroup.setCommGroupDescription("MJAx1OpIFotcdkTUtvuARXgX4s8qJsyoanAga01P8xw0MXHd9r");
