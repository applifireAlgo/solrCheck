...
Ext
		.define(
				'Proejct4.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Proejct4.view.logger.tabs.details.DetailsTab',
							'Proejct4.view.logger.tabs.fileconnector.FileConnectorTab',
							'Proejct4.view.logger.tabs.dbconnector.DBConnectorTab',
							'Proejct4.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Proejct4.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Proejct4.view.logger.LogConfigurationTabPanelController',
