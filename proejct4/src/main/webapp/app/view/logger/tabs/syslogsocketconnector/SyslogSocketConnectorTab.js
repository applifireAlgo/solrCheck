 ...
 * 
 */
Ext.define('Proejct4.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Proejct4.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
