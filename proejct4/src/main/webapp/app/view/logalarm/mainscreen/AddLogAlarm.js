 ...
 * 
 */
Ext.define('Proejct4.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Proejct4.view.logalarm.mainscreen.AddLogAlarmController',
			'Proejct4.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Proejct4.view.logalarm.mainscreen.AppAlarmPanel',
