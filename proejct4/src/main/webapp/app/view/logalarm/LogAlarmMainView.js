 ...
 * 
 */
Ext.define('Proejct4.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Proejct4.view.logalarm.LogAlarmMainViewController',
			'Proejct4.view.logalarm.tree.LogAlarmTreePanel',
			'Proejct4.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
