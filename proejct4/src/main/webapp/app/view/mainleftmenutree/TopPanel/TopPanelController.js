Ext.define('Proejct4.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	doVoiceSearch:function(btn){
		...
		if(searchTab.length==0){
			 component = Ext.create(
					"Proejct4.view.searchengine.search.SearchEngineMainPanel", {
						closable : true,
						title : "Search Engine",
						refId : "-1",
						isSearchCmp:true
	...
	onCloudClick : function()
	{
		var component = Ext.create(
				"Proejct4.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive"
					//refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Proejct4.view.usermanagement.enduser.UserProfile", {
					closable : true,
					title : "My Profile"
				});
	...
	{
		var component = Ext.create(
				"Proejct4.view.usermanagement.enduser.ChangePwd", {
					closable : true,
