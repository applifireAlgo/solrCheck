Ext.define('Proejct4.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Proejct4.view.usermanagement.admin.UserPasswordReset',
	            'Proejct4.view.usermanagement.admin.AddUserDetails',
	            'Proejct4.view.usermanagement.admin.ViewUser'],
