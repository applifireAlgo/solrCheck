Ext.define('Proejct4.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Proejct4.view.usermanagement.admin.AddUserDetailsViewModel', 'Proejct4.model.AddUserDataModel' ],
