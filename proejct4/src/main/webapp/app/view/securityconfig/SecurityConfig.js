 ...
 * 
 */
Ext.define('Proejct4.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Proejct4.view.securityconfig.SecurityConfigController',
			'Proejct4.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
