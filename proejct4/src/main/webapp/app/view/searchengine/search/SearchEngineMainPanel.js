Ext.define('Proejct4.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Proejct4.view.searchengine.search.NorthPanel', 'Proejct4.view.searchengine.search.SearchResult','Proejct4.view.searchengine.search.SearchEngineMainPanelController'],
