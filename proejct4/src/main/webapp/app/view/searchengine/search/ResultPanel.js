Ext
		.define(
				'Proejct4.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Proejct4.view.searchengine.search.SearchEngineMainPanelController','Proejct4.view.searchengine.search.PanelHeaderField' ,'Proejct4.view.searchengine.search.ReportGridView','Proejct4.view.searchengine.search.ReportChartView','Proejct4.view.searchengine.search.documentView','Proejct4.view.searchengine.search.DouMeanView','Proejct4.view.googlemaps.map.MapPanel'],
