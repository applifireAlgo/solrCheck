 ...
 */
Ext.define('Proejct4.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Proejct4.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Proejct4.view.fw.component.DateTimePicker(o);
    },
