Ext.define('Proejct4.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Proejct4.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Proejct4.view.console.ConsoleWindow');
