Ext.define('Proejct4.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Proejct4.view.reportui.datachart.chart.RatingField','Proejct4.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
