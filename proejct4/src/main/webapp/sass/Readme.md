...
folder are mapped to the application's root namespace, 'Proejct4'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Proejct4' in the same way
as `"Proejct4/sass/src"`.
