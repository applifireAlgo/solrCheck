package proejct4.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* proejct4.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* proejct4.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* proejct4.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* proejct4.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* proejct4.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* proejct4.app.server.repository..*(..))")
