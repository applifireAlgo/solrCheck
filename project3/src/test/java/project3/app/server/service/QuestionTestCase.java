...
public class QuestionTestCase {
    ...
    public void test1Save() {
        try {
            ...
            question.setQuestion("lQILyoXnNTlg1MevM8VvuaGAmXxKo7CXWffZHYKmVKmavGhrXL");
            question.setQuestionDetails("8");
            question.setQuestionIcon("9RPOIBHy6UWKbudvIQMyjUiOkoNsJjpyv1tqyKquDpIU2zfMpN");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestion("U0c2NnOWfVZONlZgKagTjRaXXQUmVSMMqoslXyvH6ipxGbYC2H");
            question.setQuestionDetails("3");
            question.setQuestionIcon("X8mEyU0PYRN9czMO56exY1UF3UaIcvbTBeme5lTJTSVpvaOqrK");
